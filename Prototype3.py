...
class MyWindowClass(QMainWindow, form_class):
    ...
    def initUI(self):
        ...
        self.x_start.textChanged.connect(self.lineEditChanged)
        self.x_end.textChanged.connect(self.lineEditChanged)
        self.y_start.textChanged.connect(self.lineEditChanged)
